                ...
                if payloadCalcSize != payloadLen:
                    ...
                    if classId == 0x01 and msgId == 0x07:
                        json = {
                            "type":"ubxNavPvt",
                            "numsv":X[13],
                            "lon":X[14] / 10000000,"lat":X[15] / 10000000,"alt":X[16],"hmsl":X[17],"hacc":X[18],"vacc":X[19],
                            "itow":X[0],
                            "year":X[1],"month":X[2],"day":X[3],"hour":X[4],"min":X[5],"sec":X[6],
                            "valid":X[7],"tacc":X[8],"nano":X[9],"fixtype":X[10],"flags":X[11],"flags2":X[12],
                            "veln":X[20] * 3.6 / 1000,"vele":X[21] * 3.6 / 1000,"veld":X[22] * 3.6 / 1000,"speed":X[23] * 3.6 / 1000,
